---
title: "Twitter hashtag crawler"
output: rmarkdown::github_document
---

This is an notebook which crawls and plots the twitter hashtags in the same context as provided hashtag.
...
```{r}
dtsc <- searchTwitter("#datascience", n=2000, lang = "en")
```
